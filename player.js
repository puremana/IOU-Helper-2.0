function Player(kongUsername, kongID, kongToken, code, gameVersion, rayVersion) {
    ...
    this.getTestUrl = function() {
        return "http://iourpg.com/test.swf?" + this.gameVersion + "&v=" + this.rayVersion + "&kongregate_username=" + this.kongUsername + "&kongregate_user_id=" + this.kongID + "&kongregate_game_auth_token=" + this.kongToken + "&kongregate_api_path=http%3A%2F%2Fchat.kongregate.com%2Fflash%2FAPI_AS3_" + this.gameCode + ".swf";
    }; 
}