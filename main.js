...
if(process.platform  == 'win32'){
  ppapi_flash_path = path.join(__dirname, 'pepflashplayer2.dll');
...
app.on('ready', function() {
  mainWindow = new BrowserWindow({
    'width': 800,
    'height': 600,
    'webPreferences': {'plugins': true, 'allowRunningInsecureContent': true, 'nodeIntegration': false}
  });
  mainWindow.loadURL('http://www.kongregate.com/games/iouRPG/idle-online-universe?acomplete=iourpg');
});
